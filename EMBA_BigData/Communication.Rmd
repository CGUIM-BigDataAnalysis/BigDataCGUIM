...
[Requirement for Using Gmail](https://rstudio.github.io/blastula/articles/sending_using_smtp.html)
```{r echo=FALSE,fig.align='center'}
knitr::include_graphics("https://github.com/CGUIM-BigDataAnalysis/BigDataCGUIM/raw/master/EMBA_BigData/figures/app_pass.png",dpi=NA)
```
...
[Download](https://github.com/CGUIM-BigDataAnalysis/BigDataCGUIM/blob/master/EMBA_BigData/flex_dash_ex.Rmd) the sample code
